...
|---------------|--------------------------------------------|
| ResNet-18     | <input type="checkbox" disabled />         |
| ResNet-34     | <input type="checkbox" disabled />         |
| ResNet 50     | <input type="checkbox" disabled checked /> |
| ResNet-100-ii | <input type="checkbox" disabled checked /> |
